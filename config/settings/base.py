...
)  # (tdx/config/settings/base.py - 3 = tdx/)
APPS_DIR = ROOT_DIR.path("tdx")
...
MIGRATION_MODULES = {"sites": "tdx.contrib.sites.migrations"}
...
ADMINS = [("""veddha edsa""", "skye.dox@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "tdx.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "tdx.users.adapters.SocialAccountAdapter"
